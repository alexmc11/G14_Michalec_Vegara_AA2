...
void Play::Draw()
{
	...
	Renderer::Instance()->PushImage(RECTANGULO_SPRITE, interfaz.puntos1BG);
	Renderer::Instance()->PushImage(RECTANGULO_SPRITE, interfaz.puntos2BG);
	Renderer::Instance()->PushImage(RECTANGULO_SPRITE, interfaz.vidas1BG);
	Renderer::Instance()->PushImage(RECTANGULO_SPRITE, interfaz.vidas2BG);
	Renderer::Instance()->PushImage(RECTANGULO_SPRITE, interfaz.tiempoBG);
